...
dx3d::SwapChain::SwapChain(const SwapChainDesc& desc, const GraphicsResourceDesc& gDesc) : GraphicsResource(gDesc), m_size(desc.windowSize)
{
	if (!desc.windowHandle) DX3DLogThrowInvalidArgument("No window handle provided!");
