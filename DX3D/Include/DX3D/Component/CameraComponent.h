...
namespace dx3d
{
	...
	class CameraComponent final : public Component
	{
		...
		private:
			Mat4x4 m_projection{};
			ProjectionMode m_projectionMode = ProjectionMode::Perspective; //Default projection mode is perspective change to orthographic if needed to have it be default
